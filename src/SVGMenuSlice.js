  ...
  return <svg height="0" width="0">
    <defs>
      <clipPath clipPathUnits="objectBoundingBox" id="sector">
        <path fill="none" stroke="#111" strokeWidth="1" className="sector"
              d={`M${startX},0.5 L1,0.5 A0.5,0.5 0 0,0 ${arcX},${arcY} L${endX},${endY} A${cutout / 2},${cutout / 2} 0 0,1 ${startX},0.5`} />
      </clipPath>
    </defs>
  </svg>
};
